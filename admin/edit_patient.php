    ...
    <nav class="navbar navbar-expand-lg bg-primary text-light fixed-top" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        <div class="container p-3">
            ...
            <div class="d-flex gap-2">
                <a href="edit_patient.php?logout" class="btn btn-primary btn btn-outline-light p-3">تسجيل خروج</a>
            </div>
        </div>
    </nav>
                            ...
                            <div class="mt-5 row w-100 justify-content-center">
                                ...
                                <form method="post" enctype="multipart/form-data" class="col-lg-4 col-md-6">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" name="fname" value="<?php echo $user['first_name'];   ?>" id="fname" required class="form-control text-start">
                                    </div>

                                    <div class="mt-3">
                                        <label for="lname">الاسم الثاني <span class="text-primary-darker">*</span></label>
                                        <input type="text" name="lname" id="lname" value="<?php echo $user['last_name'];   ?>" required class="form-control text-start">
                                    </div>
