...
$articles = mysqli_query($conn, "SELECT * FROM `articles`") or die('Query failed: ' . mysqli_error($conn));
$i=0;
...
<body class="">
    ...
    <main class="bg-light">
        <header>
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false" style="margin-top: -180px;margin-bottom: 60px;">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div style="
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <h1>مقالات طبية عن السكري</h1>
                                </div>
                                <div class="col-lg-2">
                                    <a style="background-color: #2B7BA2;border: 1px solid #2B7BA2;color: #FFF" class="btn btn-primary" href="add_article.php"><i class="fa fa-plus"></i> اضافة مقال جديد</a>
                                </div>
                            </div>
                                ...
                                <table class="table user-table no-wrap" dir="rtl">
                                    <thead dir="rtl">
                                        <tr dir="rtl">
                                            ...
                                            <th class="border-top-0">صورة المقال</th>
                                            <th class="border-top-0">عنوان المقال</th>
                                            <th class="border-top-0">المقال</th>
                                            <th class="border-top-0">العمليات</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            if (isset($articles) && mysqli_num_rows($articles) > 0) {
                                                while ($article = mysqli_fetch_assoc($articles)) {
                                                    ...
                                                    echo '<tr>
                                            <td>'.$i.'</td>
                                            <td><img src="'.$img.'" style="width: 100px;height: 60px;"></td>
                                            <td>'.$article['title'].'</td>
                                            <td style="width:450px;">'.$article['content'].'</td>
                                           
                                            <td>
                                                <a style="background-color: #2B7BA2;border: 1px solid #2B7BA2;color: #FFF" class="btn btn-primary" href="show_article.php?article_id='.$article['article_id'].'"><i class="fa fa-eye"></i> عرض بيانات المقال</a>
                                                <a style="background-color: #2B7BA2;border: 1px solid #2B7BA2;color: #FFF" class="btn btn-primary" href="edit_article.php?article_id='.$article['article_id'].'"><i class="fa fa-edit"></i> تعديل</a>
                                                <a onclick="return confirm(\'هل أنت متأكد من حذف هذا المقال ؟\');" style="background-color: #2B7BA2;border: 1px solid #2B7BA2;color: #FFF" class="btn btn-primary" href="articles.php?article_id='.$article['article_id'].'"><i class="fa fa-times"></i> حذف</a>
