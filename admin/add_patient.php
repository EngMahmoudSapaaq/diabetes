...
if (isset($_POST['submit'])) {
    ...
    $users = mysqli_query($conn, "SELECT * FROM `user` WHERE email = '$email' AND password = '$password'") or die('query failed');
        ...
        if (mysqli_num_rows($users) > 0) {
            ...
            $insert = mysqli_query($conn, "INSERT INTO `user`(first_name,last_name, email,gender,phone,username,password)"
                    . " VALUES('$fname','$lname', '$email','$gender','$phone','$username','$password')") or die('query failed');
            if ($insert) {
                $message1[] = ' تم إنشاء الحساب بنجاح';
            }
        }
}
    ...
    <nav class="navbar navbar-expand-lg bg-primary text-light fixed-top" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        <div class="container p-3">
            ...
            <div class="d-flex gap-2">
                <a href="add_patient.php?logout" class="btn btn-primary btn btn-outline-light p-3">تسجيل خروج</a>
            </div>
        </div>
    </nav>
                        ...
                        <div style="
                            ...
                            <div class="mt-5 row w-100 justify-content-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" name="fname" id="fname" required class="form-control text-start">
                                    </div>

                                    <div class="mt-3">
                                        <label for="lname">الاسم الثاني <span class="text-primary-darker">*</span></label>
                                        <input type="text" name="lname" id="lname" required class="form-control text-start">
                                    </div>
                                    ...
                                    <div class="text-center text-md-start mt-3">
                                        <button class="btn btn-primary me-3 btn-lg" type="submit" name="submit" >
                                            اضافة <i class="fa fa-arrow-left"></i>
                                        </button>
