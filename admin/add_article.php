...
if (isset($_POST['submit'])) {
   ...
   $image_folder = '../assets/img/'.$image;
    ...
    $img='assets/img/'.$image;
            $insert = mysqli_query($conn, "INSERT INTO `articles`(title,content, image)"
                    . " VALUES('$title','$content', '$img')") or die('query failed');
            if ($insert) {
                 move_uploaded_file($image_tmp_name, $image_folder);
                $message1[] = ' تم اضافة مقال بنجاح';
            } else {
                $message[] = 'لقد حدث خطأ ما في الاضافة !';
            }
    ...
    <nav class="navbar navbar-expand-lg bg-primary text-light fixed-top" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        <div class="container p-3">
            ...
            <div class="d-flex gap-2">
                <a href="add_article.php?logout" class="btn btn-primary btn btn-outline-light p-3">تسجيل خروج</a>
            </div>
        </div>
    </nav>
                            ...
                            <div class="mt-5 row w-100 justify-content-center">
                                ...
                                <form method="post" enctype="multipart/form-data" class="col-lg-4 col-md-6">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" name="title" id="title" required class="form-control text-start">
                                    </div>


                                    <div class="mt-3">
                                        <label for="phone">المقال <span class="text-primary-darker">*</span></label>
                                        <textarea type="text" name="content" required style="height: 300px;" id="phone" class="form-control text-start"></textarea>
                                    </div>
