...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['diabetes_type'])) {
        foreach ($_POST['diabetes_type'] as $check) {
            $diabetes = $check;
        }
    }
           ...
           $update_query = "UPDATE `user` SET `age` = '$age' , `weight` = '$weight', `height` = '$height', `gender` = '$gender' ,`diabetes_type` = '$diabetes'"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div style="
                            ...
                            " class="d-block w-100">
                            <h1>البيانات الطبيه والأعراض</h1>
                            <?php
                                        if (isset($message)) {
                            ...
                            <div class="mt-5 row w-100 justify-content-center">
                                <div class="col-3 mb-5">
                                    <img src="../assets/img/login.png" width="100%" alt="">
                                </div>
                                <form method="post" enctype="multipart/form-data"class="col-lg-7 col-md-6">
                                    <div class="row">
                                        <div class="mt-3 col-lg-6">
                                            <label for="fname">العمر <span class="text-primary-darker">*</span></label>
                                            <input required type="number" name="age" value="<?php echo $user['age']??NULL;  ?>" id="fname" class="form-control text-start">
                                        </div>
    
                                         <div class="mt-3 col-lg-6" name="user_gender[]">
                                    ...
                                    <div class="mt-3">
                                        <label for="phone">الوزن <span class="text-primary-darker">*</span></label>
                                        <input required type="number" name="weight" value="<?php echo $user['weight']??NULL; ?>" id="phone" class="form-control text-start">
                                    </div>

                                    <div class="mt-3">
                                        <label for="phone">الطول <span class="text-primary-darker">*</span></label>
                                        <input required type="number" name="height" value="<?php echo $user['height']??NULL;  ?>" id="phone" class="form-control text-start">
                                    </div>

                                  

                                    <div class="mt-3 col-lg-12" name="diabetes_type[]">
                                        <label for="gender">نوع السكري <span class="text-primary-darker">*</span></label>
                                        <select required id="gender" name="diabetes_type[]" class="form-control text-start">
                                            <option value="">-- اختر النوع --</option>
                                            <?php if($user['diabetes_type'] == "نوع أول"){ ?>
                                                        <option value="نوع أول" selected>نوع أول</option>
                                                         <option value="نوع ثاني">نوع ثاني</option>
                                                    <?php }else{ ?>
                                                    <option value="نوع أول">نوع أول</option>
                                                        <option value="نوع ثاني" selected>نوع ثاني</option>
                                                    <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="text-center text-md-start mt-3">
                                        <button class="btn btn-primary me-3 btn-lg" type="submit" name="submit">
                                            حفظ المعلومات <i class="fa fa-arrow-left"></i>
                                        </button>
